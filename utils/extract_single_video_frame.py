...
saved_count = 0
video = "/home/xk/pht/dataiccv/pht/pht.mp4"  # 包含视频的文件夹路径
output_folder='/home/xk/pht/dataiccv/pht/pht-ori-frames'
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
...
# output_base_folder = "/home/xk/pht/small_tools/76_ori_extract"  # 存储提取帧的基础文件夹路径
