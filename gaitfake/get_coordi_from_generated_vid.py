...
root_path='/home/xk/pht/gaitfake/perfect_gen_vid_2'
out_path='/home/xk/pht/gaitfake/yolo/data'
m = YOLO('yolov8n-seg.pt')

for vid_id in os.listdir(root_path):
    for vid in os.listdir(root_path+'/'+vid_id):
        ...
        if vid_con != 'nm-01':
            continue
        txt_path=out_path+'/perfect_txt_2/'+vid_id+'/'+vid_con
        os.makedirs(txt_path,exist_ok=True)
        vid_path=root_path+'/'+vid_id+'/'+vid
